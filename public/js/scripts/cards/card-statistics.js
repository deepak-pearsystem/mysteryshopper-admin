...
$(window).on("load", function(){
  ...
  var $danger_light = '#dd0228';
  var $blue_light = '#293ade';
  var $auqa_light = '#0dbac9';
    ...
    var newsletterChartoptions = {
        ...
        fill: {
            ...
            gradient: {
                shadeIntensity: 1,
                gradientToColors: [$auqa_light],
                opacityFrom: 1,
                opacityTo: 1,
                stops: [86, 227, 240, 100]
            }
        },
        series: [{
            name: 'Newsletter',
    ...
    var newsletterChart = new ApexCharts(
        document.querySelector("#line-area-chart-10"),
        newsletterChartoptions
    );
