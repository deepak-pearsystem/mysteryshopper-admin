...
$(window).on("load", function () {
  ...
  // plasma-donors-chart Chart starts //
  // ----------------------------------
  ...
  var orderChart = new ApexCharts(
    document.querySelector("#plasma-donors-chart"),
    orderChartoptions
  );

  orderChart.render();

  // plasma-donors-chart Chart ends //



  // oxygen-providers-chart Chart starts //
  // ----------------------------------
  ...
  var gainedChart = new ApexCharts(
    document.querySelector("#oxygen-providers-chart"),
    gainedChartoptions
  );

  gainedChart.render();

  // oxygen-providers-chart Chart ends //



  // user-list-chart Chart starts //
  // ----------------------------------
  ...
  var orderChart = new ApexCharts(
    document.querySelector("#user-list-chart"),
    orderChartoptions
  );

  orderChart.render();

  // user-list-chart Chart ends //
