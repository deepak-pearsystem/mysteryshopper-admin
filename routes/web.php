...
Route::post('register-user', 'AuthenticationController@createUser')->name('register-user');
...
Route::post('forgot/create', 'PasswordResetController@create');
...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::get('/admin-user', 'DashboardController@adminUser');
	Route::get('/access-role', 'DashboardController@accessRole');
	Route::get('/access-manager', 'DashboardController@accessManager');
	Route::get('/plasma-donors', 'DashboardController@plasmaDonors');
	Route::get('/plasmadownloadExcel', 'DashboardController@plasmadownloadExcel');
	Route::get('/oxygendownloadExcel', 'DashboardController@oxygendownloadExcel');
	Route::get('/userdownloadExcel', 'DashboardController@userdownloadExcel');
	Route::get('/inquirydownloadExcel', 'DashboardController@inquirydownloadExcel');
	Route::get('/oxygen-providers', 'DashboardController@oxygenProviders');
	Route::get('/user-list', 'DashboardController@userList');
	Route::get('/inquiries-list', 'DashboardController@inquiriesList');

	Route::get('userlogout', 'AuthenticationController@logout'); 
	Route::get('/dashboard-analytics', 'DashboardController@dashboardAnalytics');
	Route::post('/get-analytics-ajax', 'DashboardController@dashboardAnalyticsAjax');
	Route::post('/donor-ajax', 'DashboardController@donorAjax');
	Route::post('/oxyprovider-ajax', 'DashboardController@oxyProviderGraphAjax');
	Route::post('/users-ajax', 'DashboardController@userGraphAjax');
	Route::post('/add-donor', 'DashboardController@addDonor');
	Route::post('/add-oxyProvider', 'DashboardController@addOxyProvider');

	Route::get('/category', 'DashboardController@categoryDatacollect');
	Route::get('/subcategory', 'DashboardController@subcategoryDatacollect');
	Route::get('/campaign', 'DashboardController@Campaign');
	Route::get('/paymentapproval', 'DashboardController@paymentApproval');