...
class OxygenExport implements FromCollection, WithHeadings, WithEvents
{
    /**
    ...
    */
    ...
    {
		$param  = $this->param;
		$result = DB::table('OxygenCylinder')->select('id','contactPerson','cylinderCapacity','address','city','email','contactNumber','whatsappContactNumber');
		// if($param['title']!=''){		
		// 	$search = $param['title'];
