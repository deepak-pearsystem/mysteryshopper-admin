                          ...
                          <div class="card-body pt-1">
                             <form action="{{url('/reset')}}" method="post" >
							   ...
							   <input type="hidden" name="token" value="{{ $token }}">
                                   ...
                                   <fieldset class="form-label-group">
                                       <input type="password" class="form-control formfl" id="password-confirm" name="password_confirmation" placeholder="Confirm New Password" required="required">
		   <span class="text-danger error-email"></span> 
                                      <label for="user-confirm-password">Confirm Password</label>
                                  </fieldset>
                                  <div class="row pt-2">
                                      <div class="col-12 col-md-6 mb-1">
                                          <a href="{{ url('auth-login') }}" class="btn btn-outline-primary btn-block px-0">Go Back to Login</a>
                                      </div>
                                      <div class="col-12 col-md-6 mb-1">
