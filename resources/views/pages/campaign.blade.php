      ...
      <table class="table data-list-view common_table">
        <thead>
         <tr>
            ...
            <th>ID</th>
            <th>Campaign Name</th>
            <th>Data Collection Template</th>
            <th>Maximum Payment($)</th> 
            <th>Campaign Publish Date</th>
            <th>Campaign Unpublish Date</th>
            <th>Location</th>
            <th>Action</th> 
          </tr>
        </thead>
        <tbody>
            ...
            <tr>
               <td></td>
                ...
                <td>1</td>
                <td>
                  <a class="tooltiptable" href="app-todo" data-toggle="tooltip"
                        data-placement="left" title="Edit"><i class="feather icon-edit"></i>
                  </a>
                  <a class="tooltiptable" href="app-todo" data-toggle="tooltip"
                        data-placement="left" title="Download"><i class="feather icon-download"></i>
                  </a>
                  <a class="tooltiptable" href="app-todo" data-toggle="tooltip"
                        data-placement="left" title="Upload"><i class="feather icon-upload"></i>
                  </a>
                  <a class="tooltiptable" href="app-todo" data-toggle="tooltip"
                        data-placement="left" title="Calendar"><i class="feather icon-calendar"></i>
                  </a>
                  {{-- <i class="feather icon-download" title="Download"></i>
                  <i class="feather icon-upload" title="Upload"></i>
                  <i class="feather icon-calendar" title="Calendar"></i> --}}
                </td> 
            </tr>
            <tr>
              <td></td>
