        ...
        <div class="navbar-collapse" id="navbar-mobile">
          <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav bookmark-icons">
              <li class="nav-item d-none d-lg-block"><a class="nav-link" href="#"><i class="flag-icon flag-icon-in"></i><strong>India</strong></a></li>
            </ul>
          </div>
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none">
                  <span class="user-name text-bold-600">@if(Auth::user()) {{ Auth::user()->name }} @else Admin @endif</span>
                  <span class="user-status">Available</span></div><span><img class="round"
